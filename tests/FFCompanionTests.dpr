...
uses
  ...
  Models.SpellDefU in '..\models\Models.SpellDefU.pas',
  Repositories.SpellDefsU in '..\repositories\Repositories.SpellDefsU.pas',
  Models.StartingItemU in '..\models\Models.StartingItemU.pas',
  Repositories.BookStartingItemsU in '..\repositories\Repositories.BookStartingItemsU.pas',
  Repositories.AdventureSpellsU in '..\repositories\Repositories.AdventureSpellsU.pas',
  Models.AdventureSpellU in '..\models\Models.AdventureSpellU.pas',
  ...
  Services.SpellU in '..\services\Services.SpellU.pas',
  Services.AdventureCreateU in '..\services\Services.AdventureCreateU.pas',
  ...
  Tests.Repositories.SpellDefsU in 'Tests.Repositories.SpellDefsU.pas',
  Tests.Repositories.BookStartingItemsU in 'Tests.Repositories.BookStartingItemsU.pas',
  Tests.Repositories.AdventureSpellsU in 'Tests.Repositories.AdventureSpellsU.pas',
  ...
  Tests.Services.SpellU in 'Tests.Services.SpellU.pas',
  Tests.Services.AdventureCreateU in 'Tests.Services.AdventureCreateU.pas',
